...
<div class="hero-section">
    <div class="container">
        <h1>Divine Listen to spiritual...</h1>
        <p>Immerse yourself in soothing Listen to spiritual for spiritual upliftment and peace</p>
    </div>
</div>
...
<div class="container mt-5">
    ...
    <!-- Bhajans List -->
    <h2 class="section-title">Explore  spiritual Listen...</h2>
